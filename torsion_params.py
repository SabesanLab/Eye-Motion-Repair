...
volume_directory="/mnt/f/Torsion_correction_data/Image_00001_AO001R_896_512_600_50_1.57_12000_-ve0.13_Nd0.0_20ms/registervol_combine_padded"
volumes=os.path.join( volume_directory,'*registeredvol.mat')
...
# Optional:
volumes_to_process=None #range(1,11,1)  # If you specify None here, all volumes will be processed
